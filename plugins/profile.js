...
Asena.addCommand({pattern: 'kickme$', fromMe: false, desc: Lang.KICKME_DESC, onlyGroup: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'pp$', fromMe: false, desc: Lang.PP_DESC}, (async (message, match) => {    
